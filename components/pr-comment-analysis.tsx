...
export function PRCommentAnalysis({ teamId, teamName, comparisonTeamId, comparisonTeamName }: PRCommentAnalysisProps) {
  ...
  const fetchCommentAnalysis = async () => {
    try {
      setLoading(true)
      const response = await fetch(`/api/github/pr-comment-analysis?teamId=${teamId}`)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">By Team Members ({teamName})</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium">By External ({teamName})</CardTitle>
          </CardHeader>
          <CardContent>
